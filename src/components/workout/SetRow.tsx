  ...
  return (
    <div className="flex items-center gap-2 py-1.5">
      ...
      <input
        ...
        className="w-16 bg-bg border border-border rounded-lg px-2.5 py-1.5 text-sm text-text font-semibold text-center outline-none focus:border-gold transition-colors"
      />
      ...
      <input
        ...
        className="w-14 bg-bg border border-border rounded-lg px-2 py-1.5 text-sm text-text font-semibold text-center outline-none focus:border-gold transition-colors"
      />
